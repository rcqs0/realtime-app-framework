	...
	var App = React.createClass({displayName: 'App',
	    ...
	    render: function() {
	        ...
	        if (this.state.view == 'hand') {
	            view = React.createElement(Hand, null)
	        }

	        return (
	            React.createElement("div", null, 
	                React.createElement("div", null, 
	                    React.createElement("button", {onClick: this.switchToHand}, "View hand"), 
	                    React.createElement("button", {onClick: this.switchToBoard}, "View board")
	                ), 
	...
	var Hand = React.createClass({displayName: 'Hand',
	    ...
	    render: function() {
	        var cardNodes = this.state.player.answerCards.map(function(card) {
	            return React.createElement("li", {key: card.id}, card.text);
	        });

	        return (
	            React.createElement("div", null, 
	                React.createElement("div", null, 
	                    React.createElement("input", {value: this.state.username, onChange: this.handleChange, placeholder: "Enter name"}), 
	                    React.createElement("button", {onClick: this.identify}, "Identify")
	                ), 
	                React.createElement("div", null, 
